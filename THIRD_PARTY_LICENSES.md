...
- MySQL connector: `aiomysql` (MIT License). `mysql-connector-python` (GPL) is NOT used.
- Build tool: `pyinstaller` (GPLv2) — build-time only, not bundled in output binary.
- LGPL dependencies (chardet, ldap3, psycopg2-binary, etc.) — dynamically linked, no modification.
...
| azure-storage-blob                       | 12.19.1     | MIT License                                                    |
...
| boto3                                    | 1.34.34     | Apache Software License                                        |
...
| chromadb                                 | 1.0.13      | Apache Software License                                        |
| click                                    | 8.1.8       | BSD License                                                    |
| cliff                                    | 4.9.1       | Apache Software License                                        |
| cloudpathlib                             | 0.21.1      | MIT License                                                    |
| cmd2                                     | 2.7.0       | MIT License                                                    |
...
| dacite                                   | 1.9.2       | MIT License                                                    |
| dataclasses-json                         | 0.6.7       | MIT License                                                    |
| debtcollector                            | 3.0.0       | Apache Software License                                        |
...
| docling                                  | 2.47.1      | MIT                                                            |
| docling-core                             | 2.45.0      | MIT                                                            |
| docling-ibm-models                       | 3.9.0       | MIT                                                            |
| docling-parse                            | 4.2.3       | MIT                                                            |
| docx2txt                                 | 0.9         | UNKNOWN                                                        |
| dogpile.cache                            | 1.4.1       | MIT                                                            |
| duckdb                                   | 1.3.1       | MIT License                                                    |
| durationpy                               | 0.9         | MIT                                                            |
| easyocr                                  | 1.7.2       | Apache License 2.0                                             |
| ecdsa                                    | 0.19.1      | MIT                                                            |
| effdet                                   | 0.4.1       | Apache Software License                                        |
...
| fastapi                                  | 0.104.1     | MIT                                                            |
| fastembed                                | 0.7.3       | Other/Proprietary License                                      |
| fastjsonschema                           | 2.21.2      | BSD License                                                    |
| feedparser                               | 6.0.11      | BSD License                                                    |
| filelock                                 | 3.18.0      | Unlicense                                                      |
...
| great-expectations                       | 0.18.8      | Apache Software License                                        |
| grpcio                                   | 1.76.0      | Apache Software License                                        |
| grpcio-status                            | 1.72.0rc1   | Apache Software License                                        |
| grpcio-tools                             | 1.76.0      | Apache Software License                                        |
| h11                                      | 0.16.0      | MIT License                                                    |
| h2                                       | 4.3.0       | MIT License                                                    |
| hf-xet                                   | 1.1.4       | Apache-2.0                                                     |
...
| httpx-sse                                | 0.4.1       | MIT                                                            |
| huggingface-hub                          | 0.33.0      | Apache Software License                                        |
...
| keystoneauth1                            | 5.11.1      | Apache Software License                                        |
| kiwisolver                               | 1.4.7       | BSD License                                                    |
| kubernetes                               | 32.0.1      | Apache Software License                                        |
| langchain                                | 0.3.25      | MIT                                                            |
| langchain-community                      | 0.3.24      | MIT                                                            |
...
| limits                                   | 4.2         | MIT License                                                    |
| llvmlite                                 | 0.41.1      | BSD                                                            |
| loguru                                   | 0.7.3       | MIT License                                                    |
| lxml                                     | 5.4.0       | BSD License                                                    |
| macholib                                 | 1.15.2      | MIT License                                                    |
| makefun                                  | 1.16.0      | BSD License                                                    |
...
| openstacksdk                             | 4.5.0       | Apache Software License                                        |
| opentelemetry-api                        | 1.33.1      | Apache Software License                                        |
| opentelemetry-exporter-otlp-proto-common | 1.33.1      | Apache Software License                                        |
| opentelemetry-exporter-otlp-proto-grpc   | 1.33.1      | Apache Software License                                        |
| opentelemetry-instrumentation            | 0.54b1      | Apache-2.0                                                     |
| opentelemetry-instrumentation-asgi       | 0.54b1      | Apache-2.0                                                     |
| opentelemetry-instrumentation-fastapi    | 0.54b1      | Apache-2.0                                                     |
| opentelemetry-proto                      | 1.33.1      | Apache Software License                                        |
| opentelemetry-sdk                        | 1.33.1      | Apache Software License                                        |
| opentelemetry-semantic-conventions       | 0.54b1      | Apache Software License                                        |
| opentelemetry-util-http                  | 0.54b1      | Apache-2.0                                                     |
| ordered-set                              | 4.1.0       | MIT License                                                    |
| orjson                                   | 3.10.18     | Apache Software License; MIT License                           |
| os-service-types                         | 1.7.0       | Apache Software License                                        |
| osc-lib                                  | 4.0.2       | Apache Software License                                        |
| oslo.config                              | 10.0.0      | Apache Software License                                        |
| oslo.i18n                                | 6.6.0       | Apache Software License                                        |
| oslo.serialization                       | 5.8.0       | Apache Software License                                        |
| oslo.utils                               | 9.1.0       | Apache Software License                                        |
...
| phik                                     | 0.12.5      | MIT License                                                    |
| pi_heif                                  | 0.22.0      | GNU Lesser General Public License v3 (LGPLv3)                  |
| pikepdf                                  | 9.7.0       | MPL-2.0                                                        |
...
| pyOpenSSL                                | 23.3.0      | Apache Software License                                        |
| py_rust_stemmers                         | 0.1.5       | UNKNOWN                                                        |
| pyarrow                                  | 14.0.1      | Apache Software License                                        |
| pyasn1                                   | 0.6.1       | BSD License                                                    |
| pyasn1_modules                           | 0.4.2       | BSD License                                                    |
| pybase64                                 | 1.4.1       | BSD License                                                    |
| pybloom_live                             | 4.0.0       | MIT License                                                    |
...
| pymongo                                  | 4.6.0       | Apache Software License                                        |
| pyodbc                                   | 5.3.0       | MIT                                                            |
| pypandoc                                 | 1.15        | MIT License                                                    |
...
| python-cinderclient                      | 9.7.0       | Apache Software License                                        |
...
| python-keystoneclient                    | 5.6.0       | Apache Software License                                        |
| python-magic                             | 0.4.27      | MIT License                                                    |
| python-multipart                         | 0.0.6       | Apache-2.0                                                     |
| python-novaclient                        | 18.11.0     | Apache Software License                                        |
| python-openstackclient                   | 8.0.0       | Apache Software License                                        |
| python-oxmsg                             | 0.0.2       | MIT License                                                    |
| python-pptx                              | 1.0.2       | MIT License                                                    |
| pytz                                     | 2025.2      | MIT License                                                    |
| pywinrm                                  | 0.5.0       | MIT License                                                    |
...
| requests_ntlm                            | 1.3.0       | ISC License (ISCL)                                             |
| requestsexceptions                       | 1.4.0       | Apache Software License                                        |
| resend                                   | 2.21.0      | MIT License                                                    |
...
| rich-argparse                            | 1.7.2       | MIT                                                            |
| rpds-py                                  | 0.24.0      | MIT                                                            |
| rsa                                      | 4.9.1       | Apache Software License                                        |
| rtree                                    | 1.4.1       | MIT                                                            |
| ruamel.yaml                              | 0.17.17     | MIT License                                                    |
...
| semchunk                                 | 2.2.2       | MIT License                                                    |
| sentence-transformers                    | 2.5.1       | Apache Software License                                        |
...
| snowflake-connector-python               | 3.5.0       | Apache Software License                                        |
...
| timm                                     | 1.0.15      | Apache Software License                                        |
...
| unstructured                             | 0.17.2      | Apache Software License                                        |
| unstructured-client                      | 0.35.0      | MIT License                                                    |
| unstructured-inference                   | 1.0.2       | Apache Software License                                        |
| unstructured.pytesseract                 | 0.3.15      | Apache Software License                                        |
